          ...
          $rootScope.$on('$stateChangeStart', function (ev, toState, toParams){
            ...
            if(toState.name.indexOf('app') !== -1){
              if(!$auth.getUser() || $auth.getUser()['token']['exp']  <= (Date.now() / 1000) && !$auth.getToken()){
                  ...
                  $rootScope.user = $auth.getUser() || false;
                  ev.preventDefault();
                  window.location = 'http://daunhonthuyluc.com/admin_/index.html#/access/login';
                  return ;
              }
            }
      ...
      function ($stateProvider,   $urlRouterProvider, JQ_CONFIG, MODULE_CONFIG) {
          ...
          $stateProvider
              ...
              .state('app.products', {
                  ...
                  resolve: load( ['script/controllers/products/ProductCtrl.js'] )
              })

              .state('app.products_create', {
                  url: '/san-pham/tao-moi',
                  templateUrl: 'tpl/products/create.html',
                  resolve: load( ['script/controllers/products/ProductCtrl.js'] )
              })

              .state('app.products_update', {
                  url: '/san-pham/cap-nhat/:id',
                  templateUrl: 'tpl/products/update.html',
                  resolve: load( ['script/controllers/products/ProductCtrl.js'] )
              })

              

              .state('app.products_category', {
                  url: '/san-pham/danh-muc',
                  templateUrl: 'tpl/products/categories/index.html',
                  resolve: load( ['script/controllers/products/categories/ProductCategoryCtrl.js'] )
              })

              .state('app.products_provider', {
                  url: '/san-pham/nha-cung-cap',
                  templateUrl: 'tpl/products/provider/index.html',
                  resolve: load( ['script/controllers/products/provider/providerController.js'] )
              })
              ...
              .state('app.deal_pricing_list', {
                  url: '/bao-gia',
                  templateUrl: 'tpl/deal-pricing/index.html',
                  resolve: load( ['script/controllers/deal-pricing/DealPricingCtrl.js'] )
              })

              .state('app.deal_pricing', {
                  url: '/bao-gia/tao-moi',
                  templateUrl: 'tpl/deal-pricing/create.html',
                  resolve: load( ['script/controllers/deal-pricing/DealPricingCtrl.js'] )
              })
              .state('app.deal_pricing_detail', {
                  url: '/bao-gia/xem/:id',
                  templateUrl: 'tpl/deal-pricing/create.html',
                  resolve: load( ['script/controllers/deal-pricing/DealPricingCtrl.js'] )
              })
